package com.fireway.cpms.dao.util;
...
public class PasswordHash {
     ...
     */
    public static String generateStrongPasswordHash(String password) throws NoSuchAlgorithmException,
    ...
    private static String getSalt() throws NoSuchAlgorithmException {
        ...
        sr.nextBytes(salt);
        return salt.toString();// TODO: print
    }
